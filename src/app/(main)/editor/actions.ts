...
//   }
  ...
  let newPhotoData: Buffer | null = null;
let newPhotoMime: string | null = null;
...
if (photo instanceof File) {
  ...
  newPhotoData = buffer.toString("base64");
  newPhotoMime = photo.type;

  // Delete existing photo if present
  if (existingResume?.photoData) {
